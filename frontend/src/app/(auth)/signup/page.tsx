          ...
          >
            ...
            <div className="relative my-5 text-center">
              ...
              <span className="relative px-3 text-[11px] font-semibold tracking-wider text-[var(--text-tertiary)] uppercase bg-[var(--bg-card)]">
                Or sign up with OAuth 2.0
              </span>
            </div>

            {/* Official Google & Apple OAuth Signup Buttons BELOW Form */}
            <div className="space-y-2.5">
              ...
              >
                ...
                <span>Sign up with Official Google OAuth</span>
              </button>
              ...
              >
                ...
                <span>Sign up with Official Apple ID</span>
              </button>
            </div>
