...
export default function LoginPage() {
  ...
  const handleOAuthLogin = (provider: 'google' | 'apple', accountDetails?: { name: string; email: string }) => {
    setIsLoading(true);
    setTimeout(() => {
      if (loginWithOAuth) {
            ...
            {activeOAuthModal === 'google' ? (
              <div className="space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[var(--text-display)]">Sign in with Google</h3>
                    <p className="text-xs text-[var(--text-tertiary)]">Choose an account to continue to HotelHub</p>
                  </div>
                </div>

                <div className="space-y-2 pt-2">
                  <button
                    onClick={() => handleOAuthLogin('google', { name: 'Aris Setiawan', email: 'aris.setiawan@gmail.com' })}
                  ...
                  <button
                    onClick={() => handleOAuthLogin('google', { name: 'Sarah Jenkins', email: 'sarah.jenkins@gmail.com' })}
                    className="w-full p-3.5 rounded-xl border border-black/10 dark:border-white/10 flex items-center justify-between hover:bg-black/5 dark:hover:bg-white/5 transition-all text-left group"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-[var(--text-tertiary)]">sarah.jenkins@gmail.com</div>
                      </div>
                    </div>
                    <CheckCircle2 className="w-4 h-4 text-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity" />
                  </button>
              ...
              <div className="space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[var(--text-display)]">Sign in with Apple ID</h3>
                    <p className="text-xs text-[var(--text-tertiary)]">Use your Apple ID to sign in to HotelHub</p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-xs text-[var(--text-primary)] space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="font-semibold text-[var(--text-tertiary)]">Hide My Email</span>
                    <span className="font-bold text-emerald-600 dark:text-emerald-400">Enabled</span>
                  </div>
                </div>

                <button
                  onClick={() => handleOAuthLogin('apple', { name: 'Aris Setiawan', email: 'aris.setiawan@icloud.com' })}
                ...
                >
                  Continue with Touch ID / Password
                </button>
              </div>
            )}
          </div>
